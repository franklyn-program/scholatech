      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-4xl font-heading font-extrabold text-slate-900 leading-tight text-center lg:text-left">
              Our mission is to end the subscription tax on African schools.
            </h2>

            <div className="relative pl-5 border-l-2 border-[#4169FF]/30 text-left">
            ...
            <div className="pt-4 border-t border-slate-100 flex items-center gap-4 text-left">
