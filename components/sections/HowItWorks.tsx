...
const steps = [
  ...
  { num: 4, title: "Own It", description: "You receive full system deployment and local database control. No recurring fees, no lock-in.", color: "#10B981" },
];
    ...
    <section className="relative py-28 px-4 sm:px-6 lg:px-8 bg-[#0E1B38] overflow-hidden border-t border-white/10">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-20 space-y-4">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }} className="text-base sm:text-lg text-slate-300">From first call to full system ownership. No middlemen, no subscriptions.</motion.p>
        </div>
